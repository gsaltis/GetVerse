...
/*****************************************************************************!
 * Function : GotoBookChapterReference
 *****************************************************************************/
void
TextDisplayVerseWindow::GotoBookChapterReference(void)
{
  QString                               bookName;
  GotoReferenceDialog*                  dialog;

  dialog = new GotoReferenceDialog(Book, Chapter);
  if ( ! dialog->exec() ) {
    return;
  }
  ...
  emit SignalGotoBookChapter(Book, Chapter);
}
 ...
 *****************************************************************************/
void
TextDisplayVerseWindow::SlotGotoBookChapter
